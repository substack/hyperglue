...
'</div>',
'</div>',
'<div class="body">'+ ent.encode('<h1>robots!</h1>' +
'' +
'<p>Pretty great basically.</p>') + '<div>this should appear last, after everything else in .body</div></div>',
'</div>',
...
'</div>',
'</div>',
'<div class="body">' + ent.encode('<h1>title text</h1>' +
'' +
'<p>beep boop.</p>' +
'' +
'<p><em>rawr</em></p>') + '<div>this should appear last, after everything else in .body</div></div>',
'</div>',
'</div>'
];
